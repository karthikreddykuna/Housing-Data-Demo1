...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/karthikreddykuna/Housing-Data-Demo1/master/Streamlit_App_Script/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: -54818.12155703701
exported_pipeline = DecisionTreeRegressor(max_depth=6, min_samples_leaf=11, min_samples_split=5)
...
######################
# User defined values
title = 'Housing Data Demo'
encoder_location = 'https://github.com/karthikreddykuna/Housing-Data-Demo1/blob/master/Streamlit_App_Script/encoder.pkl?raw=true'
